...
public class UsernamePasswordRegisterHandlerFacadeImpl implements UsernamePasswordRegisterHandlerFacade {
    ...
    public UsernamePasswordRegisterHandlerFacadeImpl(JwtTokenProvider tokenProvider, @Qualifier("usernamePasswordRegisterHandler") RegisterHandler registerHandler, RefreshTokenHandler refreshTokenHandler) {
