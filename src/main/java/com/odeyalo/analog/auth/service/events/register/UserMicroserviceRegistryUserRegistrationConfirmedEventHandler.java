 ...
 */
@Service
public class UserMicroserviceRegistryUserRegistrationConfirmedEventHandler extends AbstractUserRegistrationConfirmedEventHandler {
    private final KafkaTemplate<String, UserRegisteredDTO> template;

    @Autowired
    public UserMicroserviceRegistryUserRegistrationConfirmedEventHandler(KafkaTemplate<String, UserRegisteredDTO> template) {
    ...
    public void handleEvent(Event event) {
        ...
        UserRegistrationConfirmedEvent userRegisteredEvent = (UserRegistrationConfirmedEvent) event;
